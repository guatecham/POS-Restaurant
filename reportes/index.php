...
<div class="container_12">
    ...
    <p>&nbsp;</p>
<!-- Tabs -->
<div class="prefix_1 grid_4 alpha"> <h2 class="title">Reporte Consolidado</h2></div>
<div class="grid_7 omega title_small"><a href="detallado.php">Detallado</a></div>
<div class="clear"></div>
<p>&nbsp;</p>
<div id="tabs">
    <ul>
    ...
    <div id="tabs-1"><?php echo reporte(date('Y-m-d'), date('Y-m-d')); ?></div>
    <div id="tabs-2"><?php echo reporte(date('Y-m-1'), date('Y-m-d')); ?></div>
    <div id="tabs-3"><?php echo reporte(date('Y-1-1'), date('Y-m-d')); ?></div>
    <div id="tabs-4">
    <?php
    ...
    <p>&nbsp;</p>
    <?php echo reporte($desdeSQL,$hastaSQL); ?>
